...
// import AuthNavigation from './src/navigations/authNavigation.jsx';
        ...
        renderItem={({item}) => {
          return(
           <View style={{flex:1, alignItems:"center", paddingTop:70}} key={item.id}>
              ...
              <Text style={{fontSize:SIZES.h1, fontWeight:"bold", lineHeight: 30, color:"black", textAlign:'center'}}>{item.title}</Text>
             </View>
            </View>
          )
        }}
